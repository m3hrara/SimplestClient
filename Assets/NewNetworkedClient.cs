...
public class NewNetworkedClient : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.C))
            SendMessageToHost(ClientToServerTransferSignifiers.CreateAccount + ",101247463,Newpass123");
        else if (Input.GetKeyDown(KeyCode.L))
            SendMessageToHost(ClientToServerTransferSignifiers.Login + ",101247463,Newpass123");
            ...
            SendMessageToHost(ClientToServerTransferSignifiers.SubmitDiscordUserName + ",Mehrara#1231");
